...
export default function Shop() {
  ...
  return (
    <section className="mx-auto max-w-[1500px] px-4 py-10 sm:px-6 lg:px-8">
      <div className="mb-8 grid gap-5 border-b border-night/25 pb-6 md:grid-cols-[1fr_auto] md:items-end">
        <div>
        ...
        <label className="flex items-center gap-2 border border-night/25 bg-paper px-4 py-3">
